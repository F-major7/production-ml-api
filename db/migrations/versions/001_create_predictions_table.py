...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_predictions_predicted_sentiment", "predictions", ["predicted_sentiment"]
    )
    op.create_index(
        "ix_predictions_timestamp_sentiment",
        "predictions",
        ["timestamp", "predicted_sentiment"],
    )
